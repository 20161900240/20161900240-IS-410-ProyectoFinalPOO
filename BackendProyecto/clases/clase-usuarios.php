<?php
    class Usuarios{
        ...
        private $publicacionesFavoritas  = array('nombrePromocion0'=>'Soy una promocion',
                                                'nombrePromocion1'=>'Soy una promocion1');
        private $empresasFavoritas = array('nombreEmpresa0'=>'Holasoyuna Empresa',
                                            'nombreEmpresa1'=>'Holasoyuna Empresa');
        private $genero;
        ...
        public static function obtenerUsuarios($referenciaBD){
            $resultado= $referenciaBD ->getReference('usuarios')
                ->getSnapshot()
                ->getValue();
